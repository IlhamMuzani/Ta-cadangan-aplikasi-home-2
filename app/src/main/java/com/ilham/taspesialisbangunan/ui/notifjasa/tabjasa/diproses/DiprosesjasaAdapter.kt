...
import kotlinx.android.synthetic.main.adapter_diprosesjasa.view.*
...
class DiprosesjasaAdapter (val context: Context, var dataPengajuan: ArrayList<DataPengajuan>,
                           val clickListener: (DataPengajuan, Int, String) -> Unit ):
        RecyclerView.Adapter<DiprosesjasaAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.adapter_diprosesjasa, parent, false)
    )
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bing(datapengajuan: DataPengajuan) {
            view.txvDeskripsiDiprosesjasa.text = datapengajuan.deskripsi
            view.txvNamajasaDiproses.text = datapengajuan.userpelanggan.username
        }
        val imvPengajuan = view.findViewById<ImageView>(R.id.imvPengajuanDiproses)
    }
