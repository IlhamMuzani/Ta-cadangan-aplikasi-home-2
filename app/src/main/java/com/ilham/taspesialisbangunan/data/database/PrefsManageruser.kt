...
class PrefsManageruser (context : Context) : Krate {

    private val PREFS_IS_LOGINUSER: String = "prefs_is_loginuser"
    ...
    init {
        sharedPreferences = context.applicationContext.getSharedPreferences(
            "Spesialis_Jb", Context.MODE_PRIVATE
        )
    }

    var prefsisLoginuser by booleanPref(PREFS_IS_LOGINUSER, false)
